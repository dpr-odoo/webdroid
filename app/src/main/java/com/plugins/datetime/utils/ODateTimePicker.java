...
public class ODateTimePicker {
    public static final String TAG = ODateTimePicker.class.getSimpleName();
    ...
    public ODateTimePicker() {

    }

    public ODateTimePicker(Context context, Builder builder) {
        mContext = context;
        mBuilder = builder;
    }
    ...
    public static class Builder {
        ...
        public ODateTimePicker build() {
            ODateTimePicker picker = new ODateTimePicker(mContext, this);
            return picker;
        }
    }
